...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pytest-forked-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pytest-forked-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pytest-forked
# for installing globally
pixi global install pytest-forked
```
...
It is possible to list all of the versions of `pytest-forked` available on your platform:
...
```
pixi search pytest-forked --channel conda-forge
```
